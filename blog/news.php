    ...
    <div class="row">
        <div class="col-8">
            ...
            <form action="/news.php?id=<?=$_GET['id']?>" method="post">
                ...
                <input type="text" name="username" id="username" class="form-control" value="<?=$_COOKIE['login']?>" readonly>
            ...
            <?php
                if(isset($_POST['username']) && isset($_POST['mess'])) {
                    ...
                    $sql = 'INSERT INTO comments(name, mess, article_id, comm_date) VALUES (?, ?, ?, ?)';
                    $query = $pdo->prepare($sql);
                    $query->execute([$username, $mess, $_GET['id'], time()]);
                }
